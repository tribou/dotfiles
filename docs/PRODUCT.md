...
- **Fast shell startup**: Lib scripts and mise activation are optimized to minimize prompt latency
...
- Shell startup time remains fast (mise activation is highly optimized; plugins are lazy-loaded)
